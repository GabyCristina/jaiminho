    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Inicio">
          <a class="nav-link" href="viewa/index.php">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Biblioteca">
          ...
          <ul class="sidenav-second-level collapse" id="collapseMulti">
            <li>
              <a href="viewa/cha.php">Plantas para chás</a>
            </li>
            </li>
            <li>
              ...
              <ul class="sidenav-third-level collapse" id="collapseMulti2">
                <li>
                  <a href="viewa/planta.php">Verduras</a>
                </li>
                <li>
                  <a href="viewa/planta.php">Oleaginosas</a>
                </li>
                <li>
                  <a href="viewa/planta.php">Vegetais</a>
                </li>
              </ul>
            </li>
          </ul>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="ControladorPergunta.php">Criar pergunta</a>
        </li>
        <li class="nav-item">
            ...
            <?php }else{ ?>
                <a class="nav-link" data-toggle="modal" data-target="#exampleModal" href="?acao=login">
                    <i class="fa fa-fw fa-sign-out"></i>Logar</a>
            <?php } ?>
        </li>
      </ul>
    </div>
...
<!--meio-->
      <h1 class="lead">Artigos Recentes</h1>

<div class="card-deck">

      <div class="card">
        <div class="card-body">
          <a href="viewa/perg.php">
          <h4 class="card-title">nome</h4>
          <p class="card-text">Preview [...]</p>
          <p class="card-text"><small class="text-muted">enviado a tempo</small></p>
        </div>
        <img class="card-img-bottom" src="../../assets/img/MENTHA-SPICATA1.jpg" alt="Card image cap">
      </a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-outline-success" href="../controlador/controlador.php?acao=logout">Logout</a>
          </div>
        </div>
      </div>
    </div>
